...
const PUBLIC = ['index.html', ...(process.env.PUBLISH_CNAME === '1' ? ['CNAME'] : []), 'css', 'fonts', 'assets', 'js/holo.js', 'js/fit.js', 'js/hero-mesh.js', 'js/bike.js', 'js/manifest.js', 'js/hand.js', 'js/scenes.js', 'js/colors.js', 'js/grasp-layout.js', 'js/contact.js'];
...
const keyProblem = contactKeyProblem(html, { allowUnconfigured: process.env.ALLOW_UNCONFIGURED_CONTACT === '1' });
